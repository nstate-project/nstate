...
2. Copy it to `bg/README.md` and replace the template placeholders
...
Eurostat publishes comparable data for Bulgaria alongside all EU27 countries:
...
Use Eurostat country code **BG** to filter for Bulgaria specifically.

## Questions?

Open an issue tagged `[bg]` in the [nstate repository](https://github.com/nstate-project/nstate).
