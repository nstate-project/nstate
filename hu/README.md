...
2. Copy it to `hu/README.md` and replace the template placeholders
...
Eurostat publishes comparable data for Hungary alongside all EU27 countries:
...
Use Eurostat country code **HU** to filter for Hungary specifically.

## Questions?

Open an issue tagged `[hu]` in the [nstate repository](https://github.com/nstate-project/nstate).
