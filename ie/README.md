...
2. Copy it to `ie/README.md` and replace the template placeholders
...
Eurostat publishes comparable data for Ireland alongside all EU27 countries:
...
Use Eurostat country code **IE** to filter for Ireland specifically.

## Questions?

Open an issue tagged `[ie]` in the [nstate repository](https://github.com/nstate-project/nstate).
