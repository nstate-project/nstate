...
2. Copy it to `cz/README.md` and replace the template placeholders
...
Eurostat publishes comparable data for Czech Republic alongside all EU27 countries:
...
Use Eurostat country code **CZ** to filter for Czech Republic specifically.

## Questions?

Open an issue tagged `[cz]` in the [nstate repository](https://github.com/nstate-project/nstate).
