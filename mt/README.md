...
2. Copy it to `mt/README.md` and replace the template placeholders
...
Eurostat publishes comparable data for Malta alongside all EU27 countries:
...
Use Eurostat country code **MT** to filter for Malta specifically.

## Questions?

Open an issue tagged `[mt]` in the [nstate repository](https://github.com/nstate-project/nstate).
