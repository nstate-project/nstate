...
2. Copy it to `cy/README.md` and replace the template placeholders
...
Eurostat publishes comparable data for Cyprus alongside all EU27 countries:
...
Use Eurostat country code **CY** to filter for Cyprus specifically.

## Questions?

Open an issue tagged `[cy]` in the [nstate repository](https://github.com/nstate-project/nstate).
