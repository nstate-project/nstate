...
2. Copy it to `be/README.md` and replace the template placeholders
...
Eurostat publishes comparable data for Belgium alongside all EU27 countries:
...
Use Eurostat country code **BE** to filter for Belgium specifically.

## Questions?

Open an issue tagged `[be]` in the [nstate repository](https://github.com/nstate-project/nstate).
