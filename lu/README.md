...
2. Copy it to `lu/README.md` and replace the template placeholders
...
Eurostat publishes comparable data for Luxembourg alongside all EU27 countries:
...
Use Eurostat country code **LU** to filter for Luxembourg specifically.

## Questions?

Open an issue tagged `[lu]` in the [nstate repository](https://github.com/nstate-project/nstate).
