...
2. Copy it to `sk/README.md` and replace the template placeholders
...
Eurostat publishes comparable data for Slovakia alongside all EU27 countries:
...
Use Eurostat country code **SK** to filter for Slovakia specifically.

## Questions?

Open an issue tagged `[sk]` in the [nstate repository](https://github.com/nstate-project/nstate).
