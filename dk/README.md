...
2. Copy it to `dk/README.md` and replace the template placeholders
...
Eurostat publishes comparable data for Denmark alongside all EU27 countries:
...
Use Eurostat country code **DK** to filter for Denmark specifically.

## Questions?

Open an issue tagged `[dk]` in the [nstate repository](https://github.com/nstate-project/nstate).
