...
2. Copy it to `se/README.md` and replace the template placeholders
...
Eurostat publishes comparable data for Sweden alongside all EU27 countries:
...
Use Eurostat country code **SE** to filter for Sweden specifically.

## Questions?

Open an issue tagged `[se]` in the [nstate repository](https://github.com/nstate-project/nstate).
