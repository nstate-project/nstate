...
2. Copy it to `si/README.md` and replace the template placeholders
...
Eurostat publishes comparable data for Slovenia alongside all EU27 countries:
...
Use Eurostat country code **SI** to filter for Slovenia specifically.

## Questions?

Open an issue tagged `[si]` in the [nstate repository](https://github.com/nstate-project/nstate).
