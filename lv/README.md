...
2. Copy it to `lv/README.md` and replace the template placeholders
...
Eurostat publishes comparable data for Latvia alongside all EU27 countries:
...
Use Eurostat country code **LV** to filter for Latvia specifically.

## Questions?

Open an issue tagged `[lv]` in the [nstate repository](https://github.com/nstate-project/nstate).
