...
2. Copy it to `pl/README.md` and replace the template placeholders
...
Eurostat publishes comparable data for Poland alongside all EU27 countries:
...
Use Eurostat country code **PL** to filter for Poland specifically.

## Questions?

Open an issue tagged `[pl]` in the [nstate repository](https://github.com/nstate-project/nstate).
