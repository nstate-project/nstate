...
2. Copy it to `fi/README.md` and replace the template placeholders
...
Eurostat publishes comparable data for Finland alongside all EU27 countries:
...
Use Eurostat country code **FI** to filter for Finland specifically.

## Questions?

Open an issue tagged `[fi]` in the [nstate repository](https://github.com/nstate-project/nstate).
