...
2. Copy it to `lt/README.md` and replace the template placeholders
...
Eurostat publishes comparable data for Lithuania alongside all EU27 countries:
...
Use Eurostat country code **LT** to filter for Lithuania specifically.

## Questions?

Open an issue tagged `[lt]` in the [nstate repository](https://github.com/nstate-project/nstate).
