...
2. Copy it to `at/README.md` and replace the template placeholders
...
Eurostat publishes comparable data for Austria alongside all EU27 countries:
...
Use Eurostat country code **AT** to filter for Austria specifically.

## Questions?

Open an issue tagged `[at]` in the [nstate repository](https://github.com/nstate-project/nstate).
