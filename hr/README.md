...
2. Copy it to `hr/README.md` and replace the template placeholders
...
Eurostat publishes comparable data for Croatia alongside all EU27 countries:
...
Use Eurostat country code **HR** to filter for Croatia specifically.

## Questions?

Open an issue tagged `[hr]` in the [nstate repository](https://github.com/nstate-project/nstate).
