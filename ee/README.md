...
2. Copy it to `ee/README.md` and replace the template placeholders
...
Eurostat publishes comparable data for Estonia alongside all EU27 countries:
...
Use Eurostat country code **EE** to filter for Estonia specifically.

## Questions?

Open an issue tagged `[ee]` in the [nstate repository](https://github.com/nstate-project/nstate).
